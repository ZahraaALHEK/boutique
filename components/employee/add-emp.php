...
if(isset($_POST) & !empty($_POST)){
    ...
    $query1 = "INSERT INTO `users` (id,username,password,role) VALUES ('$id','$username','$hash','employee')";
	$res1 = mysqli_query($connection, $query1);


	$query2 = "INSERT INTO `employee` (u_id,username,password,salary) VALUES ('$id','$username','$hash', '$salary')";
